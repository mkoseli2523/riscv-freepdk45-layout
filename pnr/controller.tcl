...
floorPlan -site CoreSite -d 100 100 10 10 10 10
...
editPin -pin alu_mux_1_sel -layer metal6 -assign 60 100 -side BOTTOM -fixed
editPin -pin alu_mux_2_sel -layer metal6 -assign 70 100 -side BOTTOM -fixed
editPin -pin alu_inv_rs2 -layer metal6 -assign 80 100 -side BOTTOM -fixed
editPin -pin alu_cin -layer metal6 -assign 90 100 -side BOTTOM -fixed
editPin -pin alu_op[0] -layer metal6 -assign 100 100 -side BOTTOM -fixed
editPin -pin alu_op[1] -layer metal6 -assign 110 100 -side BOTTOM -fixed
editPin -pin shift_msb -layer metal6 -assign 120 100 -side BOTTOM -fixed
editPin -pin shift_dir -layer metal6 -assign 130 100 -side BOTTOM -fixed
editPin -pin cmp_mux_sel -layer metal6 -assign 140 100 -side BOTTOM -fixed
editPin -pin pc_mux_sel -layer metal6 -assign 150 100 -side BOTTOM -fixed

editPin -pin mem_mux_sel[0] -layer metal6 -assign 160 100 -side BOTTOM -fixed
editPin -pin mem_mux_sel[1] -layer metal6 -assign 170 100 -side BOTTOM -fixed
editPin -pin mem_mux_sel[2] -layer metal6 -assign 180 100 -side BOTTOM -fixed

editPin -pin rd_mux_sel[0] -layer metal6 -assign 190 100 -side BOTTOM -fixed
editPin -pin rd_mux_sel[1] -layer metal6 -assign 200 100 -side BOTTOM -fixed
editPin -pin rd_mux_sel[2] -layer metal6 -assign 210 100 -side BOTTOM -fixed

editPin -pin cmp_out -layer metal6 -assign 100 100 -side BOTTOM -fixed

for {set i 0} {$i < 32} {incr i} {
    editPin -pin "rs1_sel\[$i\]" -layer metal3 -assign [expr 10 + $i*6] 10 -side BOTTOM -fixed
    editPin -pin "rs2_sel\[$i\]" -layer metal3 -assign [expr 10 + $i*6] 30 -side BOTTOM -fixed
    editPin -pin "rd_sel\[$i\]" -layer metal3 -assign [expr 10 + $i*6] 50 -side BOTTOM -fixed
    editPin -pin "imm\[$i\]" -layer metal6 -assign [expr 10 + $i*6] 70 -side RIGHT -fixed
}
